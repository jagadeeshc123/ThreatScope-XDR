...
const ProductionReadinessPage=lazy(()=>import('./pages/operations/ProductionReadinessPage').then(m=>({default:m.ProductionReadinessPage})));
...
const AnalyticsOverviewPage=lazy(()=>import('./pages/analytics/AnalyticsPages').then(m=>({default:m.AnalyticsOverviewPage})));const DetectorsPage=lazy(()=>import('./pages/analytics/AnalyticsPages').then(m=>({default:m.DetectorsPage})));const DetectorNewPage=lazy(()=>import('./pages/analytics/AnalyticsPages').then(m=>({default:m.DetectorNewPage})));const DetectorDetailsPage=lazy(()=>import('./pages/analytics/AnalyticsPages').then(m=>({default:m.DetectorDetailsPage})));const DetectorEditPage=lazy(()=>import('./pages/analytics/AnalyticsPages').then(m=>({default:m.DetectorEditPage})));const DetectorVersionsPage=lazy(()=>import('./pages/analytics/AnalyticsPages').then(m=>({default:m.DetectorVersionsPage})));const DetectorTrainingRunsPage=lazy(()=>import('./pages/analytics/AnalyticsPages').then(m=>({default:m.DetectorTrainingRunsPage})));const DetectorEvaluationsPage=lazy(()=>import('./pages/analytics/AnalyticsPages').then(m=>({default:m.DetectorEvaluationsPage})));const BaselinesPage=lazy(()=>import('./pages/analytics/AnalyticsPages').then(m=>({default:m.BaselinesPage})));const BaselineDetailsPage=lazy(()=>import('./pages/analytics/AnalyticsPages').then(m=>({default:m.BaselineDetailsPage})));const AnomaliesPage=lazy(()=>import('./pages/analytics/AnalyticsPages').then(m=>({default:m.AnomaliesPage})));const AnomalyDetailsPage=lazy(()=>import('./pages/analytics/AnalyticsPages').then(m=>({default:m.AnomalyDetailsPage})));const AnomalyExplanationPage=lazy(()=>import('./pages/analytics/AnalyticsPages').then(m=>({default:m.AnomalyExplanationPage})));const ReviewQueuePage=lazy(()=>import('./pages/analytics/AnalyticsPages').then(m=>({default:m.ReviewQueuePage})));const FeedbackPage=lazy(()=>import('./pages/analytics/AnalyticsPages').then(m=>({default:m.FeedbackPage})));const SuppressionsPage=lazy(()=>import('./pages/analytics/AnalyticsPages').then(m=>({default:m.SuppressionsPage})));const SuppressionNewPage=lazy(()=>import('./pages/analytics/AnalyticsPages').then(m=>({default:m.SuppressionNewPage})));const SuppressionDetailsPage=lazy(()=>import('./pages/analytics/AnalyticsPages').then(m=>({default:m.SuppressionDetailsPage})));const DriftPage=lazy(()=>import('./pages/analytics/AnalyticsPages').then(m=>({default:m.DriftPage})));const DriftDetailsPage=lazy(()=>import('./pages/analytics/AnalyticsPages').then(m=>({default:m.DriftDetailsPage})));const AnalyticsJobsPage=lazy(()=>import('./pages/analytics/AnalyticsPages').then(m=>({default:m.AnalyticsJobsPage})));const AnalyticsJobDetailsPage=lazy(()=>import('./pages/analytics/AnalyticsPages').then(m=>({default:m.AnalyticsJobDetailsPage})));const AnalyticsReportsPage=lazy(()=>import('./pages/analytics/AnalyticsPages').then(m=>({default:m.AnalyticsReportsPage})));const AnalyticsReportDetailsPage=lazy(()=>import('./pages/analytics/AnalyticsPages').then(m=>({default:m.AnalyticsReportDetailsPage})));const AnalyticsSettingsPage=lazy(()=>import('./pages/analytics/AnalyticsPages').then(m=>({default:m.AnalyticsSettingsPage})));
    ...
    <div className="flex min-h-screen overflow-hidden bg-background text-foreground">
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        ...
        <main className="min-w-0 flex-1 overflow-y-auto overflow-x-hidden">
          <Suspense fallback={<LoadingRoute/>}><Outlet /></Suspense>
        </main>
      </div>
    </div>
  );
    ...
    <Router>
      ...
      <Routes>
        ...
        <Route element={<Layout />}>
          ...
          <Route path="/analytics/detectors" element={<DetectorsPage/>}/><Route path="/analytics/detectors/new" element={<DetectorNewPage/>}/><Route path="/analytics/detectors/:id" element={<DetectorDetailsPage/>}/><Route path="/analytics/detectors/:id/edit" element={<DetectorEditPage/>}/><Route path="/analytics/detectors/:id/versions" element={<DetectorVersionsPage/>}/><Route path="/analytics/detectors/:id/training-runs" element={<DetectorTrainingRunsPage/>}/><Route path="/analytics/detectors/:id/evaluations" element={<DetectorEvaluationsPage/>}/>
          <Route path="/analytics/baselines" element={<BaselinesPage/>}/><Route path="/analytics/baselines/:id" element={<BaselineDetailsPage/>}/>
          <Route path="/analytics/anomalies" element={<AnomaliesPage/>}/><Route path="/analytics/anomalies/:id" element={<AnomalyDetailsPage/>}/><Route path="/analytics/anomalies/:id/explanation" element={<AnomalyExplanationPage/>}/><Route path="/analytics/review-queue" element={<ReviewQueuePage/>}/><Route path="/analytics/feedback" element={<FeedbackPage/>}/>
          <Route path="/analytics/suppressions" element={<SuppressionsPage/>}/><Route path="/analytics/suppressions/new" element={<SuppressionNewPage/>}/><Route path="/analytics/suppressions/:id" element={<SuppressionDetailsPage/>}/>
          <Route path="/analytics/drift" element={<DriftPage/>}/><Route path="/analytics/drift/:id" element={<DriftDetailsPage/>}/><Route path="/analytics/jobs" element={<AnalyticsJobsPage/>}/><Route path="/analytics/jobs/:id" element={<AnalyticsJobDetailsPage/>}/><Route path="/analytics/reports" element={<AnalyticsReportsPage/>}/><Route path="/analytics/reports/:id" element={<AnalyticsReportDetailsPage/>}/><Route path="/analytics/settings" element={<AnalyticsSettingsPage/>}/>
          ...
          <Route path="/operations/production-readiness" element={<Suspense fallback={<LoadingRoute/>}><ProductionReadinessPage/></Suspense>}/>
