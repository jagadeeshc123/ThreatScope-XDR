...
import { Shield, LayoutDashboard, Target, Activity, FileText, Settings, Network, Radar, ChevronDown, FileSearch, MailWarning, GitMerge, Scale, Users, KeyRound, ScrollText, User, Wrench } from 'lucide-react';
