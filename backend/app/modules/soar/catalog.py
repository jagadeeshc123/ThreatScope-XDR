...
_READ_ONLY = [
    ...
    ("load_anomaly_context", "Load security anomaly context", "analytics", "analytics:view"),
...
_LOCAL = [
    ...
    ("create_anomaly_case_proposal", "Create anomaly case proposal", "analytics", "harmless_local", "analytics:review", None, True, True),
    ("request_anomaly_review", "Request anomaly analyst review", "analytics", "harmless_local", "analytics:review", None, True, False),
    ("generate_analytics_report", "Generate bounded analytics report", "analytics", "controlled_local", "analytics:export", None, False, False),
    ("add_anomaly_tag", "Add approved anomaly tag", "analytics", "harmless_local", "analytics:review", None, True, True),
